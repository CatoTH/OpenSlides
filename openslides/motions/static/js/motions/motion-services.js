...
.factory('ChangeRecommmendationCreate', [
    ...
    function(ngDialog, ChangeRecommendationForm) {
        ...
        obj.init = function (_motion, _scope) {
            $scope = _scope;
            motion = _motion;
    ...
    function (Motion, MotionChangeRecommendation, Config, Projector, lineNumberingService, diffService, $http, $interval) {
        ...
        obj.formatChangeRecommendation = function (motion, version, change) {
            ...
            var data = diffService.extractRangeByLineNumbers(html, change.line_from, change.line_to),
                ...
                oldTextWithBreaks = lineNumberingService.insertLineNumbersNode(oldText, lineLength, null, change.line_from),
                newTextWithBreaks = lineNumberingService.insertLineNumbersNode(change.text, lineLength, null, change.line_from);
